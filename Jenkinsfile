pipeline {
    ...
    stages {
        ...
        stage('Sonarqube Analysis') {
            steps {
                bat ''' %SCANNER_HOME%/bin/sonar-scanner -Dsonar.sources=. -Dsonar.host.url=http://localhost:9000 -Dsonar.login=squ_7a0f1937e2c4c81598e00ee66300c17ca406bba3 -Dsonar.projectName=gtps \
