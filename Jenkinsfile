pipeline {
    ...
    stages {
        ...
        stage('Sonarqube Analysis') {
            steps {
                bat ''' %SCANNER_HOME%/bin/sonar-scanner -Dsonar.sources=. -Dsonar.host.url=http://localhost:9000 -Dsonar.login=squ_8608b71722326c644dd0f1490a097116a2a5216e -Dsonar.projectName=gtps \
