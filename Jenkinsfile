pipeline {
    ...
    stages {
        ...
        stage('Sonarqube Analysis') {
            steps {
                bat ''' %SCANNER_HOME%/bin/sonar-scanner -Dsonar.sources=. -Dsonar.host.url=http://localhost:9000 -Dsonar.login=squ_496563dfbc66f9c3c7159fff505dc7e30dcc9bbe -Dsonar.projectName=gtps \
